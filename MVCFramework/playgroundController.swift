...
// Originally downloaded from: https://github.com/kickstarter/ios-oss/blob/master/Kickstarter-iOS.playground/Sources/playgroundController.swift
...
public func playgroundControllers(device: Device = .phone4_7inch,
    ...
    -> (parent: UIViewController, child: UIViewController) {
        ...
        // Fix for error with Xcode 10 Beta 3
        ...
        parent.add(asChildViewController: child)
